...
async def main():
    ...
    try:
        if CONFIG['offline_mode']:
            ...
            # DYNAMIC INJECTION: Fetch and assign live risk-free rate from IBKR thread
            CONFIG['risk_free_rate'] = await harvester.fetch_live_ibkr_risk_free_rate()
        ...
        # Math (will automatically use the newly assigned CONFIG['risk_free_rate'])
