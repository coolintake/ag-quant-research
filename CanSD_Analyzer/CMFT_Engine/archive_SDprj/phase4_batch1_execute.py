"""
Phase 4 Batch 1 Execution Script
Reads raw StatCan CSV data, applies 5/3/4 cumulative YTD interpolation,
dynamic CANSIM starting stocks, and writes *_Mo tabs to CanadaSD_Main.xlsx.
"""
...
# ============================================================
# FSR & CARRYOUT SOLVER (from engine_balancer.py)
# ============================================================
...
def solve_fsr_carryout(df_wide: pd.DataFrame) -> pd.DataFrame:
    ...
    for commodity in df['Commodity_Norm'].unique():
        ...
        # Forward-fill Beginning Stocks from previous Ending Stocks
        comm_data['Beginning Stocks'] = comm_data['Beginning Stocks'].fillna(
            comm_data['Ending Stocks'].shift(1)
        )
        
        # Compute FSR as residual where Ending Stocks is known
        supply = (
...
def main():
    print("="*60)
    print("PHASE 4 BATCH 1 - EXECUTION")
    print("="*60)
